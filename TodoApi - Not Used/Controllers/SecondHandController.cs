...
namespace TodoApi.Controllers
{
    ...
    public class SecondHandController : ControllerBase
    {
        ...
        public readonly ICrudProduto _todos;

        public SecondHandController(ICrudProduto _todoItems)
        {
            _todos = _todoItems;
        ...
        //[HttpGet]
        //public async Task<ActionResult<List<ProdutoDTO>>> GetTodoItems()
        //{
        ...
        {
            var nro = _todos.getProdutos();
        
            return nro;
        }

        //[HttpGet("{id}")]
        //public async Task<ActionResult<ProdutoDTO>> GetTodoItem(int id)
        //{
